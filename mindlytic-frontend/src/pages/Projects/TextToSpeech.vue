...
const stop = () => {
  ...
  isPlaying.value = false;
  isDownloading.value = false; // Also reset download state
};
...
<template>
  ...
  <v-container style="min-height: 84.3vh !important">
    <v-card class="text-h5 text-center my-3 pa-4" color="primary-lighten-5" border="primary md opacity-100" rounded="xl" flat>
    ...
    <v-card class="pa-4 pa-md-8 rounded-xl" border>
      <v-row>
        ...
        <v-col cols="12" md="6" class="d-flex align-center ga-3">
            ...
            <v-tooltip location="top" text="Requires screen share permission to capture tab audio.">
    ...
    >
      <v-card-text>
        <div>
          Note: This tool uses your browser's built-in Web Speech API. The available voices depend on your operating system and browser.
