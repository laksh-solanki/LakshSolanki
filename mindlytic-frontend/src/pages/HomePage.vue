      ...
      <v-container>
        <v-row align="center" justify="center">
          <v-col cols="12" md="8" lg="7" class="text-center">
            <v-chip color="primary" variant="flat" size="small" class="mb-6 font-weight-bold text-uppercase spacing-1">
              New Release v2.0
            </v-chip>
      ...
      <v-container>
        <v-row justify="center" align="center">
          <v-col v-for="client in clients" :key="client" cols="6" md="2"
            ...
            <span class="text-h6 font-weight-bold text-grey-darken-1">{{ client.text }}</span>
          </v-col>
        </v-row>
      </v-container>
    </section>
