...
const templates = [
  {
    ...
    css: `body{margin:0;min-height:100vh;display:grid;place-items:center;font-family:Segoe UI,sans-serif;background:linear-gradient(150deg,#f8fbfd,#eef6f4);color:#103832}.card{width:min(90vw,560px);padding:24px;border-radius:16px;border:1px solid rgba(15,143,124,.18);background:rgba(255,255,255,.96);box-shadow:0 18px 36px rgba(18,38,33,.08)}button{border:0;padding:10px 14px;border-radius:999px;background:#0f8f7c;color:#f7fffd;font-weight:700;cursor:pointer}#out{margin-top:12px;color:#4f6f69}`,
